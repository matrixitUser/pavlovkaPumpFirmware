...
signed int _printf(uint8_t loglevel,const char *pFormat, ...)
{
	//uint8_t  gPrintf = 1; //0 - не печатать
	if (loglevel >= gPrintf) return 0;  //loglevel= 0- печатать всегда. 2 только при gPrintf=1 или 2 и т юд
    va_list ap;
    signed int result;
